...
const CoolModal = ({children, onCloseClicked, title = ""}: Props) => {
    ...
    return createPortal(
        <div className="relative z-10 border-teal-700 border-2" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            ...
            <div className="fixed inset-0 z-10 overflow-y-auto">
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center p-5">
                    <div
                        ...
                        {(title || onCloseClicked) &&
                            <div className="flex items-start justify-between p-4 border-b rounded-t bg-teal-700">
                                {title && <h3 className="text-xl font-semibold text-gray-100">
                                    {title}
                                </h3>}
